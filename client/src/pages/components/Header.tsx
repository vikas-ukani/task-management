...
export default function Header() {
    ...
    return (
        <div className=" bg-[#fffaf2]">
            <nav className="2xl:container 2xl:mx-auto sm:py-3 sm:px-7 py-3 px-4 w-full border-b shadow-[0_1px_14px_rgba(0,0,0,0.07)] sticky top-0 z-20">
                ...
                <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} items-center sm:hidden mt-4 mx-auto duration-500`}>
                    <div className="flex flex-col gap-4 my-8 w-80 mx-auto ">
                        <GoogleLogin />
                    </div>
                </div>
            </nav>
